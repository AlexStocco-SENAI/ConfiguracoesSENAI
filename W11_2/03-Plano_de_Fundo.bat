...
curl -L https://alexstocco-senai.github.io/ConfiguracoesSENAI/W11_2/SENAI.theme" -o "C:\Windows\Resources\Themes\SENAI.theme"start "" "C:\Windows\Resources\Themes\SENAI.theme"
